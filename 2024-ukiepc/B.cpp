...
int N, M;
double sq[1000005], sx[1000005], sy[1000005], sxy[1000005];
...
int main() {
    ...
    scanf("%d", &M);
    rep(i,0,M) {
        int l, r; double lam, X; scanf("%d %d %lf %lf", &l, &r, &lam, &X);
        double sx1 = sx[r]-sx[l-1];
        double sy1 = sy[r]-sy[l-1];
        double sq1 = sq[r]-sq[l-1];
        double sxy1 = sxy[r]-sxy[l-1];
        double a = lam+sq1;
        double b = sx1;
        double c = sx1;
        double d = lam+(r-l+1);
        double r1 = sxy1;
        double r2 = sy1;
        double K = (r1*d - b*r2) / (a*d - b*c);
        double B = (a*r2 - r1*c) / (a*d - b*c);
        double ans = K*X + B;
        printf("%.10lf\n", ans);
    }
