...
int main() {
    ...
    rep(i,1,N) {
        ...
        rep(j,1,i+2) {
            rep(k,0,N-2) {
                rep(l,0,3) {
                    dp[1][j][k][0] = ad(dp[1][j][k][0], sub(pre[0][i][k][l], pre[0][j-1][k][l]));
                }
            }
        }
        // l -> l+1
        rep(j,1,i+2) {
            rep(k,0,N-2) {
                rep(l,0,3) {
                    int n = min(l+1, 2);
                    int v = (l==2);
                    dp[1][j][k+v][n] = ad(dp[1][j][k+v][n], pre[0][j-1][k][l]);
                }
            }
        }
        rep(j,1,i+2) {
            rep(k,0,N-1) {
                rep(l,0,3) {
                    pre[1][j][k][l] = ad(pre[1][j-1][k][l], dp[1][j][k][l]);
                }
            }
        }
        rep(j,1,i+2) {
